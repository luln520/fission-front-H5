        ...
        <div className="homePopCenter-1">
          <div className="profile-header">
            ...
            <div className="profile-info">
              <div className="profile-name">{userInfo?.username}
                <img src="/home/vip.png"
                     alt="VIP"
                     className="vip-icon"/>
              </div>
              <div className="profile-id" onClick={() => handleCopy(userInfo?.userCode)}>
                ...
                <span style={{marginLeft: '.5rem', fontSize: '.83rem'}}>
                  <svg xmlns="http://www.w3.org/2000/svg"
                       ...
                       viewBox="0 0 24 24"><g fill="none"
                                              ...
                                              stroke-width="2"><rect width="14"
                                                                     height="14"
                                                                     x="8"
                                                                     y="8"
                                                                     rx="2"
                                                                     ry="2"/><path d="M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2"/></g></svg>
                </span>
              </div>
            </div>
          </div>
