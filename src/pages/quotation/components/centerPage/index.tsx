...
export default function CenterPage({
  ...
  console.log(4, coinListData);

  return (
    <div className="market-center">
      <div className="market-center-header">
        <section className={type == 1 ? "market-center-header-act" : ""}>
          <main
            onClick={() => {
              setType(1);
            }}
                ...
                >
                  <g id="编组-4" transform="translate(205.000000, 139.000000)">
                    <g id="编组-2" transform="translate(10.916667, 3.000000)">
                      <path
                        d="M13.378864,13.125 L1.78742303,13.125 C0.40682551,13.125 -0.452212948,11.6511719 0.2506367,10.4863281 L6.0463572,0.861328125 C6.39220386,0.287109375 6.98906824,0 7.58314354,0 C8.17721883,0 8.77408322,0.287109375 9.11992987,0.861328125 L14.9156504,10.4835937 C15.6185,11.6511719 14.7622506,13.125 13.378864,13.125 L13.378864,13.125 Z"
                        id="路径"
                        fill="#000000"
                        opacity="0.178619385"
                      ></path>
                      <path
                        d="M14.9156504,19.5136719 L9.11992987,29.1386719 C8.77408322,29.7128906 8.17721883,30 7.58314354,30 C6.98906824,30 6.39220386,29.7128906 6.0463572,29.1386719 L0.2506367,19.5136719 C-0.452212948,18.3460937 0.40682551,16.875 1.78742303,16.875 L13.378864,16.875 C14.7622506,16.875 15.6185,18.3488281 14.9156504,19.5136719 Z"
                        id="路径"
                        fill="#04CF99"
                      ></path>
                    </g>
        ...
        <aside />
        <section className={type == 2 ? "market-center-header-act" : ""}>
          <main
            onClick={() => {
              setType(2);
            }}
        ...
        {Object.keys(coinListData).map((key) => {
          ...
          return (
            ...
            >
              ...
              <div className="market-center-list-item-close">{item.close}</div>
              <section
                style={{
                  background:
                    item.close < coinListData[key]?.open
                      ? "#FF0000"
                      : "#04CF99",
                }}
                className="market-center-list-item-up"
              >
                {coinListData[key]?.close < coinListData[key]?.open ? "" : "+"}
                {coinListData[key]?.close &&
                  (
