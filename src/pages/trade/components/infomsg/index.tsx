...
export default function InfoMsg({setvisibleInfoMsg}) {
  ...
  return (
    <div className="tradeinfomsg-1">
      <div className="tradeinfomsg-2">
        <strong className="tradeinfomsg-3">{translate(getText("交割合约规则说明"))}</strong>
      </div>
      <div className="tradeinfomsg-4">
        {translate(getText("預測未來一段時間的漲跌。以下單時間的價格為起始價，以預測週期最後一秒的價格為結算價，結算價大於起始價則為漲，結算價小於起始價則為跌。"))}
      </div>
      <div className="tradeinfomsg-5">
        <div className="tradeinfomsg-6" onClick={()=>{
